...
Window_Base.prototype.drawActorHp = function(actor, x, y, width) {
    ...
    this.drawGauge(x, y - 2, width, actor.hpRate(), color1, color2);
    this.changeTextColor(this.systemColor());
    this.drawText(TextManager.hpA, x, y - 2, 44);
    this.drawCurrentAndMax(actor.hp, actor.mhp, x, y - 2, width, this.hpColor(actor), this.normalColor());
};
...
Window_Base.prototype.drawActorMp = function(actor, x, y, width) {
    ...
    this.drawGauge(x, y - 2, width, actor.mpRate(), color1, color2);
    this.changeTextColor(this.systemColor());
    this.drawText(TextManager.mpA, x, y - 2, 44);
    this.drawCurrentAndMax(actor.mp, actor.mmp, x, y - 2, width, this.mpColor(actor), this.normalColor());
};
...
Window_Base.prototype.drawActorTp = function(actor, x, y, width) {
    ...
    this.drawGauge(x, y - 2, width, actor.tpRate(), color1, color2);
    this.changeTextColor(this.systemColor());
    this.drawText(TextManager.tpA, x, y - 2, 44);
    this.changeTextColor(this.tpColor(actor));
    this.drawText(actor.tp, x + width - 64, y - 2, 64, 'right');
};
